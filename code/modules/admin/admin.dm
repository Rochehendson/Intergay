...
/datum/admins/proc/Game()
	...
	dat += {"
		<a href='byond://?src=\ref[src];c_aspect=1'>Change Round Aspect</A><br>
		<BR>
...
/datum/admins/proc/faxCallback(obj/item/paper/admin/P)
	...
	if (success)
		...
		if(P.sender) // sent as a reply
			...
			for(var/client/C as anything in GLOB.admins)
				if((R_INVESTIGATE) & C.holder.rights)
					to_chat(C, "<span class='log_message'><span class='prefix'>FAX LOG:</span>[key_name_admin(src.owner)] has sent a fax message to [P.department] (<a href='byond://?_src_=holder;AdminFaxView=\ref[rcvdcopy]'>VIEW</a>)</span>")
	else
